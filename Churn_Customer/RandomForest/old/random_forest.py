"""
Churn Customer — Random Forest Experiment 1
...
from sklearn.ensemble import RandomForestClassifier  # <--- שינוי מודל לרנדום פורסט
...
# =========================================================
# 1. Paths (קריאה זהה לחלוטין למבנה שלכם)
# =========================================================
...
print("=" * 70)
print("Churn Customer — Random Forest Experiment 1 (Baseline)")
print("=" * 70)
...
# =========================================================
# 2. Load data (קריאה זהה ישירות מתוך קובץ ה-Excel והגיליון הנכון)
# =========================================================
...
# <--- תיקון מובנה: וידוא ועגינה של עמודות המלל כטקסט נקי על מנת למנוע את קריסת ה-Imputer
...
# שימי לב: עבור Random Forest הסרנו את ה-StandardScaler כיוון שמודלים מבוססי עצים אינם זקוקים לנרמול מרחקי נתונים
...
print("\n" + "=" * 70)
print("Random Forest Experiment 1 complete.")
print("=" * 70)