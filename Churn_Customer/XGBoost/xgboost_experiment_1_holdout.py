"""
Churn Customer — XGBoost Experiment 1 (with held-out test set)

Same baseline pipeline as xgboost_experiment_1.py, but with a proper
train/test split: 70% train, 30% test (stratified, random_state=42).

The test set is held out completely — the 5-fold CV and threshold sweep
run on TRAIN only. TEST is touched exactly once, at the end, to report
an unbiased final estimate.

Imbalance ratio: computed from TRAIN only -> scale_pos_weight
...
print("=" * 70)
print("Churn Customer - XGBoost Experiment 1 (Baseline + Holdout)")
print("=" * 70)
...
# =========================================================
# 4. Feature selection (same as xgboost_experiment_1)
# =========================================================
...
# =========================================================
# 7. Cross-validation evaluation - TRAIN only
# =========================================================
...
# =========================================================
# 8. Threshold sweep (TRAIN OOF only)
# =========================================================

print("\n" + "=" * 70)
print("Threshold sweep on TRAIN OOF (Recall vs Precision tradeoff):")
print("=" * 70)
...
# =========================================================
# 9. Final holdout check - TEST set, touched exactly once
# =========================================================
...
summary = {
    ...
    "train_pr_auc": round(m_train["pr_auc"], 6),
    ...
    "test_pr_auc": round(m_test["pr_auc"], 6),
}

SUMMARY_FILE = BASE_DIR / "xgboost_experiment_1_holdout_summary.csv"
pd.DataFrame([summary], index=["xgboost_experiment_1_holdout"]).to_csv(SUMMARY_FILE, index=True)
