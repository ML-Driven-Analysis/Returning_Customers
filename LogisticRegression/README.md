...
**מסקנה:** הוספת `class_weight='balanced'` שינתה דרמטית את ההתנהגות — Recall קלאס 0 קפץ מ-3% ל-51%. המודל כעת מאוזן בין הקלאסים. ROC AUC נשאר 0.475 כי מדד זה תלוי-ספף ו-class_weight משנה רק את סף ההחלטה, לא את הכוח ההפרדתי.
